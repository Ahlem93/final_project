            ...
            <div class="col-lg-11 col-md-12">
              <div class="property_block_wrap style-4">
                <div class="prt-detail-title-desc">
                  ...
                  <span>
                    <i class="lni-map-marker"></i> {properties.address}{" "}
                    {properties.city}
                  </span>
                  <h3 class="prt-price-fix">
                    {properties.price} DT<sub>/month</sub>
                  </h3>
                ...
                <div className="property_block_wrap_header">
                  ...
                  >
                    <h4 className="property_block_title">
                      {comments ? comments.length : ""} Review
                    </h4>
                  </a>
                </div>
